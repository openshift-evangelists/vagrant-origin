...
/utils/gitlab/create-nfs-pv.sh pv-gitlab-redis-data gitlab gitlab-ce-redis-data
/utils/gitlab/create-nfs-pv.sh pv-gitlab-etc        gitlab gitlab-ce-etc
/utils/gitlab/create-nfs-pv.sh pv-gitlab-logs       gitlab gitlab-ce-logs
/utils/gitlab/create-nfs-pv.sh pv-gitlab-opt        gitlab gitlab-ce-opt
/utils/gitlab/create-nfs-pv.sh pv-gitlab-postgresql gitlab gitlab-ce-postgresql
